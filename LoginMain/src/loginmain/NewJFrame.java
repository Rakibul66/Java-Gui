...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        if(uname.equals("roxy")&& psd.equals("roxy7777"))
        {
            
            JOptionPane.showMessageDialog(b1,"you succesfully login");
            Second s=new Second();
            s.setVisible(true);
        }
        else
        {
            ...
            JOptionPane.showMessageDialog(b1,"Invalid username or password","warning",JOptionPane.ERROR_MESSAGE);
        }
